...
def base_shape(letter):
    # Define rough vector-like stroke paths for letters A–E
    shapes = {
        'A': [(0, 100), (50, 0), (100, 100), (75, 50), (25, 50)],
        'B': [(0, 0), (0, 100), (60, 100), (60, 75), (0, 50), (60, 50), (60, 25), (0, 0)],
        'C': [(100, 0), (50, 0), (0, 50), (50, 100), (100, 100)],
        'D': [(0, 0), (0, 100), (60, 90), (80, 50), (60, 10), (0, 0)],
        'E': [(100, 0), (0, 0), (0, 100), (100, 100), (0, 50), (70, 50)],
    }
...
print("✅ All letter data generated manually — no fonts required!")
